...
final lowStockProductsProvider = FutureProvider<List<ProductRecord>>((ref) async {
  final response = await ref.watch(inventoryRepositoryProvider).getLowStockProducts();
